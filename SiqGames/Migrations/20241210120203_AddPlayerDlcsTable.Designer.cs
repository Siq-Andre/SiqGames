...
namespace SiqGames.Migrations
{
    ...
    [Migration("20241210120203_AddPlayerDlcsTable")]
    partial class AddPlayerDlcsTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DlcPlayer", b =>
                {
                    ...
                    b.HasKey("DlcsId", "PlayersId");

                    b.HasIndex("PlayersId");

                    b.ToTable("PlayerDlcs", (string)null);
                });
            ...
            modelBuilder.Entity("DlcPlayer", b =>
                {
                    b.HasOne("SiqGames.Entities.Dlc", null)
                        .WithMany()
